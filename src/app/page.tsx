    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-4">
        ...
        <div className="grid grid-cols-4 gap-3 mb-5">
          ...
          <a href="/search" className="bg-white rounded-2xl p-3 text-center shadow-sm border hover:shadow-md transition">
            <div className="text-2xl mb-1">🔍</div>
            <div className="text-xs font-medium text-gray-700">검색</div>
          </a>
        ...
        <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm border text-center">
          <p className="text-2xl font-bold text-gray-900">
            📅 {today.getMonth() + 1}월 {today.getDate()}일 ({dayNames[today.getDay()]}요일) 메뉴
          </p>
        </div>
                    ...
                    {items.map((item, idx) => {
                      ...
                      if (icon) {
                        return (
                          <span
                            key={idx}
                            className="bg-orange-50 border-2 border-orange-300 text-orange-800 px-3 py-1.5 rounded-full text-sm font-bold"
                          >
                            {icon} {item}
                          </span>
                        )
                      ...
                      return (
                        <span
                          key={idx}
                          className="bg-gray-50 border border-gray-200 text-gray-600 px-2.5 py-1 rounded-full text-xs"
                        >
                          {item}
                        </span>
                      )
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-5 border border-blue-100">
          ...
          <div className="flex gap-2">
            <a href="mailto:kbioin@naver.com" className="flex-1 text-center bg-blue-500 text-white py-2 rounded-xl text-sm font-medium">
              이메일 문의
            </a>
            <a href="https://open.kakao.com/o/sV5Fw9mi" target="_blank" className="flex-1 text-center bg-yellow-400 text-yellow-900 py-2 rounded-xl text-sm font-medium">
              카카오톡 문의
            </a>
          </div>
        </div>
        ...
        <div className="mt-4 bg-orange-50 rounded-2xl p-5 border border-orange-200">
          ...
          <div className="flex gap-2">
            <a href="/owner/register" className="flex-1 text-center bg-orange-500 text-white py-2 rounded-xl text-sm font-bold">
              가게 등록하기
            </a>
            <a href="/owner" className="flex-1 text-center bg-white text-orange-600 border border-orange-300 py-2 rounded-xl text-sm font-bold">
              메뉴 올리기
            </a>
          </div>
        </div>
